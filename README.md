...
<p align="center">
Engineering Student @ ESPRIT • Building Production-Ready AI Systems
</p>
...
<p align="center">
<img src="https://komarev.com/ghpvc/?username=dridi10331&label=Profile%20Views&color=0e75b6&style=flat"/>
</p>
...
<img src="https://skillicons.dev/icons?i=python,fastapi,pytorch,tensorflow,postgresql,docker,git,linux,vscode"/>
...
|----------|--------------|
| 🛍️ **ShopVision** | YOLOv12s • FastAPI • PostgreSQL • Supabase • Streamlit |
| 🚗 **Car Damage Detection** | YOLOv8 • OpenCV • PyTorch |
| 📄 **OCR Document Chatbot** | LangChain • FastAPI • FAISS • Groq |
| 💼 **CV Job Matching** | NLP • Transformers • Python |
| 🤖 **AI Code Review Agent** | LLMs • FastAPI • GitHub |

---

# 💼 Experience

## Computer Vision / ML Engineering Intern — ITGate

- Built a real-time visual search system
- Reduced inference latency by **40%**
- Reduced false positives by **65%**
- Designed PostgreSQL/Supabase backend
- Optimized production inference pipeline

---

## Data Analyst Intern — Unfrauded

- Processed **10,000+ insurance claims**
- Built fraud detection workflows
- Optimized SQLite queries to **sub-50ms**
- Developed dashboards using Apache Superset
...
- 🇫🇷 **French** — **DALF C1**
  - 🏅 (https://github.com/dridi10331/dridi10331/blob/main/diplome.png)
